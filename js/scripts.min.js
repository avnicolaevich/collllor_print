!function (e, t) {
    ...
    function f(e, t, n, i, r) {
        for (var o, s, a, l, c, f, p = t.createDocumentFragment(), h = [], g = 0,
                 v = e.length; v > g; g++)if ((o = e[g]) || 0 === o)if ("object" === oe.type(o)) oe.merge(h, o.nodeType ? [o] : o); else if (Oe.test(o)) {
            for (s = s || p.appendChild(t.createElement("div")), a = (je.exec(o) || ["", ""])[1].toLowerCase(), l = qe[a] || qe._default, s.innerHTML = l[1] + oe.htmlPrefilter(o) + l[2], f = l[0]; f--;)s = s.lastChild;
            oe.merge(h, s.childNodes), s = p.firstChild, s.textContent = ""
        } else h.push(t.createTextNode(o));
        for (p.textContent = "", g = 0; o = h[g++];)if (i && oe.inArray(o, i) > -1) r && r.push(o); else if (c = oe.contains(o.ownerDocument, o), s = u(p.appendChild(o), "script"), c && d(s), n)for (f = 0; o = s[f++];)Le.test(o.type || "") && n.push(o);
        return p
    }
    ...
    function b(e, t) {
        var n, i, r, o, s, a, l, c;
        if (1 === t.nodeType) {
            if (we.hasData(e) && (o = we.access(e), s = we.set(t, o), c = o.events)) {
    ...
    function C(e, t, n, i) {
        t = Q.apply([], t);
        var r, o, s, a, l, c, d = 0, p = e.length, h = p - 1, g = t[0], v = oe.isFunction(g);
        if (v || p > 1 && "string" == typeof g && !ie.checkClone && Me.test(g))return e.each(function (r) {
            var o = e.eq(r);
            v && (t[0] = g.call(this, r, o.html())), C(o, t, n, i)
        });
        if (p && (r = f(t, e[0].ownerDocument, !1, e, i), o = r.firstChild, 1 === r.childNodes.length && (r = o), o || i)) {
            for (s = oe.map(u(r, "script"), y), a = s.length; p > d; d++)l = r, d !== h && (l = oe.clone(l, !0, !0), a && oe.merge(s, u(l, "script"))), n.call(e[d], l, d);
            if (a)for (c = s[s.length - 1].ownerDocument, oe.map(s, x), d = 0; a > d; d++)l = s[d], Le.test(l.type || "") && !we.access(l, "globalEval") && oe.contains(c, l) && (l.src ? oe._evalUrl && oe._evalUrl(l.src) : oe.globalEval(l.textContent.replace($e, "")))
        }
        return e
    }

    function T(e, t, n) {
        for (var i, r = t ? oe.filter(t, e) : e,
                 o = 0; null != (i = r[o]); o++)n || 1 !== i.nodeType || oe.cleanData(u(i)), i.parentNode && (n && oe.contains(i.ownerDocument, i) && d(u(i, "script")), i.parentNode.removeChild(i));
        return e
    }
    ...
    function D(e) {
        var t = G, n = Be[e];
        return n || (n = k(e, t), "none" !== n && n || (We = (We || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = We[0].contentDocument, t.write(), t.close(), n = k(e, t), We.detach()), Be[e] = n), n
    }

    function S(e, t, n) {
        var i, r, o, s, a = e.style;
        return n = n || Xe(e), s = n ? n.getPropertyValue(t) || n[t] : void 0, "" !== s && void 0 !== s || oe.contains(e.ownerDocument, e) || (s = oe.style(e, t)), n && !ie.pixelMarginRight() && _e.test(s) && ze.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o), void 0 !== s ? s + "" : s
    }
    ...
    function j(e, t, n, i, r) {
        for (var o = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0,
                 s = 0; 4 > o; o += 2)"margin" === n && (s += oe.css(e, n + Ee[o], !0, r)), i ? ("content" === n && (s -= oe.css(e, "padding" + Ee[o], !0, r)), "margin" !== n && (s -= oe.css(e, "border" + Ee[o] + "Width", !0, r))) : (s += oe.css(e, "padding" + Ee[o], !0, r), "padding" !== n && (s += oe.css(e, "border" + Ee[o] + "Width", !0, r)));
        return s
    }

    function L(t, n, i) {
        var r = !0, o = "width" === n ? t.offsetWidth : t.offsetHeight, s = Xe(t),
        ...
        if (G.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), 0 >= o || null == o) {
            if (o = S(t, n, s), (0 > o || null == o) && (o = t.style[n]), _e.test(o))return o;
    ...
    function q(e, t) {
        for (var n, i, r, o = [], s = 0,
                 a = e.length; a > s; s++)i = e[s], i.style && (o[s] = we.get(i, "olddisplay"), n = i.style.display, t ? (o[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Ne(i) && (o[s] = we.access(i, "olddisplay", D(i.nodeName)))) : (r = Ne(i), "none" === n && r || we.set(i, "olddisplay", r ? n : oe.css(i, "display"))));
    ...
    function F(e, t, n) {
        for (var i, r = (R.tweeners[t] || []).concat(R.tweeners["*"]), o = 0,
                 s = r.length; s > o; o++)if (i = r[o].call(n, t, e))return i
    }

    function P(e, t, n) {
        var i, r, o, s, a, l, c, u = this, d = {}, f = e.style, p = e.nodeType && Ne(e), h = we.get(e, "fxshow");
        ...
        if (oe.isEmptyObject(d)) "inline" === ("none" === c ? D(e.nodeName) : c) && (f.display = c); else {
            ...
            for (i in d)s = F(p ? h[i] : 0, i, u), i in h || (h[i] = s.start, p && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
        }
    }

    function M(e, t) {
        var n, i, r, o, s;
        for (n in e)if (i = oe.camelCase(n), r = t[i], o = e[n], oe.isArray(o) && (r = o[1], o = e[n] = o[0]), n !== i && (e[i] = o, delete e[n]), (s = oe.cssHooks[i]) && "expand" in s) {
    ...
    function R(e, t, n) {
        var i, r, o = 0, s = R.prefilters.length, a = oe.Deferred().always(function () {
            ...
            if (r)return !1;
            for (var t = Ze || H(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, o = 1 - i,
                     s = 0, l = c.tweens.length; l > s; s++)c.tweens[s].run(o);
        ...
        for (M(u, c.opts.specialEasing); s > o; o++)if (i = R.prefilters[o].call(c, e, u, c.opts))return oe.isFunction(i.stop) && (oe._queueHooks(c.elem, c.opts.queue).stop = oe.proxy(i.stop, i)), i;
    ...
    function V(e, t, n, i) {
        ...
        if (oe.isArray(t)) oe.each(t, function (t, r) {
            n || bt.test(e) ? i(e, r) : V(e + "[" + ("object" == typeof r && null != r ? t : "") + "]", r, n, i)
    ...
    var Y = [], G = e.document, J = Y.slice, Q = Y.concat, K = Y.push, Z = Y.indexOf, ee = {}, te = ee.toString,
        ne = ee.hasOwnProperty, ie = {}, re = "2.2.1", oe = function (e, t) {
    ...
    oe.fn = oe.prototype = {
        ...
        expando: "jQuery" + (re + Math.random()).replace(/\D/g, ""), isReady: !0, error: function (e) {
            ...
            var n, i, r;
            return "string" == typeof t && (n = e[t], t = e, e = n), oe.isFunction(e) ? (i = J.call(arguments, 2), r = function () {
    ...
    var ae = function (e) {
        function t(e, t, n, i) {
            var r, o, s, a, c, d, f, p, h = t && t.ownerDocument, g = t ? t.nodeType : 9;
            if (n = n || [], "string" != typeof e || !e || 1 !== g && 9 !== g && 11 !== g)return n;
            if (!i && ((t ? t.ownerDocument || t : M) !== j && A(t), t = t || j, q)) {
                if (11 !== g && (d = ge.exec(e)))if (r = d[1]) {
                    ...
                    if ((r = d[3]) && x.getElementsByClassName && t.getElementsByClassName)return J.apply(n, t.getElementsByClassName(r)), n
                }
                if (x.qsa && !z[e + " "] && (!O || !O.test(e))) {
                    if (1 !== g) h = t, p = e; else if ("object" !== t.nodeName.toLowerCase()) {
                        for ((a = t.getAttribute("id")) ? a = a.replace(me, "\\$&") : t.setAttribute("id", a = P), f = T(e), o = f.length, c = ue.test(a) ? "#" + a : "[id='" + a + "']"; o--;)f[o] = c + " " + u(f[o]);
        ...
        function d(e, t, n) {
            ...
            return t.first ? function (t, n, o) {
                ...
                if (s) {
                    ...
                    if (c = t[P] || (t[P] = {}), l = c[t.uniqueID] || (c[t.uniqueID] = {}), (a = l[i]) && a[0] === R && a[1] === o)return u[2] = a[2];
        ...
        function h(e, t, n, i, r) {
            for (var o, s = [], a = 0, l = e.length,
                     c = null != t; l > a; a++)(o = e[a]) && (!n || n(o, i, r)) && (s.push(o), c && t.push(a));
            return s
        }

        function g(e, t, n, r, o, s) {
            return r && !r[P] && (r = g(r)), o && !o[P] && (o = g(o, s)), i(function (i, s, a, l) {
                var c, u, d, f = [], g = [], v = s.length, m = i || p(t || "*", a.nodeType ? [a] : a, []),
                    y = !e || !i && t ? m : h(m, f, e, a, l), x = n ? o || (i ? e : v || r) ? [] : s : y;
                if (n && n(y, x, a, l), r)for (c = h(x, g), r(c, [], a, l), u = c.length; u--;)(d = c[u]) && (x[g[u]] = !(y[g[u]] = d));
                if (i) {
                    if (o || e) {
                        if (o) {
                        ...
                        for (u = x.length; u--;)(d = x[u]) && (c = o ? K(i, d) : f[u]) > -1 && (i[c] = !(s[c] = d))
                    }
                } else x = h(x === s ? x.splice(v, x.length) : x), o ? o(null, s, x, l) : J.apply(s, x)
            })
        }

        function v(e) {
            for (var t, n, i, r = e.length, o = b.relative[e[0].type], s = o || b.relative[" "], a = o ? 1 : 0,
                     l = d(function (e) {
                         return e === t
                     }, s, !0), c = d(function (e) {
                    return K(t, e) > -1
                    ...
                    return t = null, r
                }]; r > a; a++)if (n = b.relative[e[a].type]) p = [d(f(p), n)]; else {
                if (n = b.filter[e[a].type].apply(null, e[a].matches), n[P]) {
                    for (i = ++a; r > i && !b.relative[e[i].type]; i++);
                    return g(a > 1 && f(p), a > 1 && u(e.slice(0, a - 1).concat({value: " " === e[a - 2].type ? "*" : ""})).replace(oe, "$1"), n, i > a && v(e.slice(a, i)), r > i && v(e = e.slice(i)), r > i && u(e))
                }
                p.push(n)
            }
            return f(p)
        ...
        function m(e, n) {
            var r = n.length > 0, o = e.length > 0, s = function (i, s, a, l, c) {
                var u, d, f, p = 0, g = "0", v = i && [], m = [], y = S, x = i || o && b.find.TAG("*", c),
                    w = R += null == y ? 1 : Math.random() || .1, C = x.length;
                for (c && (S = s === j || s || c); g !== C && null != (u = x[g]); g++) {
                    if (o && u) {
                        for (d = 0, s || u.ownerDocument === j || (A(u), a = !q); f = e[d++];)if (f(u, s || j, a)) {
                            l.push(u);
                            break
                        }
                        c && (R = w)
                ...
                if (p += g, r && g !== p) {
                    ...
                    if (i) {
                        if (p > 0)for (; g--;)v[g] || m[g] || (m[g] = Y.call(l));
                        m = h(m)
                    }
        ...
        var y, x, b, w, C, T, k, D, S, E, N, A, j, L, q, O, H, I, F, P = "sizzle" + 1 * new Date, M = e.document, R = 0,
            $ = 0, W = n(), B = n(), z = n(), _ = function (e, t) {
                return e === t && (N = !0), 0
            }, X = 1 << 31, V = {}.hasOwnProperty, U = [], Y = U.pop, G = U.push, J = U.push, Q = U.slice,
            K = function (e, t) {
        ...
        try {
            J.apply(U = Q.call(M.childNodes), M.childNodes), U[M.childNodes.length].nodeType
        } catch (e) {
            J = {
        ...
        x = t.support = {}, C = t.isXML = function (e) {
            ...
            return i !== j && 9 === i.nodeType && i.documentElement ? (j = i, L = j.documentElement, q = !C(j), (n = j.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", be, !1) : n.attachEvent && n.attachEvent("onunload", be)), x.attributes = r(function (e) {
                ...
                return L.appendChild(e).id = P, !j.getElementsByName || !j.getElementsByName(P).length
                ...
                return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !x.sortDetached && t.compareDocumentPosition(e) === n ? e === j || e.ownerDocument === M && F(M, e) ? -1 : t === j || t.ownerDocument === M && F(M, t) ? 1 : E ? K(E, e) - K(E, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t)return N = !0, 0;
            ...
            if ((e.ownerDocument || e) !== j && A(e), n = n.replace(le, "='$1']"), x.matchesSelector && q && !z[n + " "] && (!H || !H.test(n)) && (!O || !O.test(n)))try {
                var i = I.call(e, n);
            ...
            return (e.ownerDocument || e) !== j && A(e), F(e, t)
        }, t.attr = function (e, t) {
            (e.ownerDocument || e) !== j && A(e);
            var n = b.attrHandle[t.toLowerCase()],
                i = n && V.call(b.attrHandle, t.toLowerCase()) ? n(e, t, !q) : void 0;
            return void 0 !== i ? i : x.attributes || !q ? e.getAttribute(t) : (i = e.getAttributeNode(t)) && i.specified ? i.value : null
        }, t.error = function (e) {
            throw new Error("Syntax error, unrecognized expression: " + e)
        }, t.uniqueSort = function (e) {
            var t, n = [], i = 0, r = 0;
            if (N = !x.detectDuplicates, E = !x.sortStable && e.slice(0), e.sort(_), N) {
            ...
            filter: {
                TAG: function (e) {
                    ...
                    return 1 === i && 0 === r ? function (e) {
                        ...
                        var c, u, d, f, p, h, g = o !== s ? "nextSibling" : "previousSibling", v = t.parentNode,
                            m = a && t.nodeName.toLowerCase(), y = !l && !a, x = !1;
                        if (v) {
                            if (o) {
                                for (; g;) {
                            ...
                            if (h = [s ? v.firstChild : v.lastChild], s && y) {
                                for (f = v, d = f[P] || (f[P] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], p = c[0] === R && c[1], x = p && c[2], f = p && v.childNodes[p]; f = ++p && f && f[g] || (x = p = 0) || h.pop();)if (1 === f.nodeType && ++x && f === t) {
                                    u[e] = [R, p, x];
                                    break
                                }
                            } else if (y && (f = t, d = f[P] || (f[P] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], p = c[0] === R && c[1], x = p), !1 === x)for (; (f = ++p && f && f[g] || (x = p = 0) || h.pop()) && ((a ? f.nodeName.toLowerCase() !== m : 1 !== f.nodeType) || !++x || (y && (d = f[P] || (f[P] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), u[e] = [R, x]), f !== t)););
                            return (x -= r) === i || x % i == 0 && x / i >= 0
                        }
                    }
                }, PSEUDO: function (e, n) {
                    var r, o = b.pseudos[e] || b.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);
                    return o[P] ? o(n) : o.length > 1 ? (r = [e, e, "", n], b.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, t) {
        ...
        return c.prototype = b.filters = b.pseudos, b.setFilters = new c, T = t.tokenize = function (e, n) {
            ...
            for (a = e, l = [], c = b.preFilter; a;) {
                ...
                for (s in b.filter)!(r = de[s].exec(a)) || c[s] && !(r = c[s](r)) || (i = r.shift(), o.push({
                    value: i,
                    type: s,
                    matches: r
                }), a = a.slice(i.length));
            ...
            var n, i = [], r = [], o = z[e + " "];
            if (!o) {
                for (t || (t = T(e)), n = t.length; n--;)o = v(t[n]), o[P] ? i.push(o) : r.push(o);
                o = z(e, m(r, i)), o.selector = e
            }
            return o
        }, D = t.select = function (e, t, n, i) {
            var r, o, s, a, c, d = "function" == typeof e && e, f = !i && T(e = d.selector || e);
            if (n = n || [], 1 === f.length) {
                if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && x.getById && 9 === t.nodeType && q && b.relative[o[1].type]) {
                    if (!(t = (b.find.ID(s.matches[0].replace(ye, xe), t) || [])[0]))return n;
                    d && (t = t.parentNode), e = e.slice(o.shift().value.length)
                }
                for (r = de.needsContext.test(e) ? 0 : o.length; r-- && (s = o[r], !b.relative[a = s.type]);)if ((c = b.find[a]) && (i = c(s.matches[0].replace(ye, xe), ve.test(o[0].type) && l(t.parentNode) || t))) {
                    if (o.splice(r, 1), !(e = i.length && u(o)))return J.apply(n, i), n;
                    break
                }
            }
            return (d || k(e, f))(i, t, !q, n, !t || ve.test(e) && l(t.parentNode) || t), n
        }, x.sortStable = P.split("").sort(_).join("") === P, x.detectDuplicates = !!N, A(), x.sortDetached = r(function (e) {
    ...
    var le = function (e, t, n) {
        ...
        return n
    }, ue = oe.expr.match.needsContext, de = /^<([\w-]+)\s*\/?>(?:<\/\1>|)$/, fe = /^.[^:#\[\.,]*$/;
    ...
    (oe.fn.init = function (e, t, n) {
        ...
        if (n = n || pe, "string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof oe ? t[0] : t, oe.merge(this, oe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : G, !0)), de.test(i[1]) && oe.isPlainObject(t))for (i in t)oe.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
    ...
    oe.fn.extend({
        has: function (e) {
            ...
            for (var n, i = 0, r = this.length, o = [],
                     s = ue.test(e) || "string" != typeof e ? oe(e, t || this.context) : 0; r > i; i++)for (n = this[i]; n && n !== t; n = n.parentNode)if (n.nodeType < 11 && (s ? s.index(n) > -1 : 1 === n.nodeType && oe.find.matchesSelector(n, e))) {
                o.push(n);
                break
            }
    ...
    oe.Callbacks = function (e) {
        ...
        Deferred: function (e) {
            ...
            var t, n, i, r = 0, o = J.call(arguments), s = o.length,
    ...
    var we = new a, Ce = new a, Te = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, ke = /[A-Z]/g;
    oe.extend({
        hasData: function (e) {
        ...
        data: function (e, t) {
            ...
            return "object" == typeof e ? this.each(function () {
                ...
                var n, i;
                if (o && void 0 === t) {
                    if (void 0 !== (n = Ce.get(o, e) || Ce.get(o, e.replace(ke, "-$&").toLowerCase())))return n;
    ...
    var De = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Se = new RegExp("^(?:([+-])=|)(" + De + ")([a-z%]*)$", "i"),
        Ee = ["Top", "Right", "Bottom", "Left"], Ne = function (e, t) {
            return e = t || e, "none" === oe.css(e, "display") || !oe.contains(e.ownerDocument, e)
        }, Ae = /^(?:checkbox|radio)$/i, je = /<([\w:-]+)/, Le = /^$|\/(?:java|ecma)script/i, qe = {
    ...
    var He = /^key/, Ie = /^(?:mouse|pointer|contextmenu|drag|drop)|click/, Fe = /^([^.]*)(?:\.(.+)|)/;
    oe.event = {
        global: {},
        add: function (e, t, n, i, r) {
            var o, s, a, l, c, u, d, f, p, h, g, v = we.get(e);
            if (v)for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = oe.guid++), (l = v.events) || (l = v.events = {}), (s = v.handle) || (s = v.handle = function (t) {
            ...
            }), t = (t || "").match(me) || [""], c = t.length; c--;)a = Fe.exec(t[c]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p && (d = oe.event.special[p] || {}, p = (r ? d.delegateType : d.bindType) || p, d = oe.event.special[p] || {}, u = oe.extend({
                type: p,
                origType: g,
                data: i,
                handler: n,
                ...
                namespace: h.join(".")
            }, o), (f = l[p]) || (f = l[p] = [], f.delegateCount = 0, d.setup && !1 !== d.setup.call(e, i, h, s) || e.addEventListener && e.addEventListener(p, s)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? f.splice(f.delegateCount++, 0, u) : f.push(u), oe.event.global[p] = !0)
        },
        remove: function (e, t, n, i, r) {
            var o, s, a, l, c, u, d, f, p, h, g, v = we.hasData(e) && we.get(e);
            if (v && (l = v.events)) {
                for (t = (t || "").match(me) || [""], c = t.length; c--;)if (a = Fe.exec(t[c]) || [], p = g = a[1], h = (a[2] || "").split(".").sort(), p) {
                    for (d = oe.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, f = l[p] || [], a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = o = f.length; o--;)u = f[o], !r && g !== u.origType || n && n.guid !== u.guid || a && !a.test(u.namespace) || i && i !== u.selector && ("**" !== i || !u.selector) || (f.splice(o, 1), u.selector && f.delegateCount--, d.remove && d.remove.call(e, u));
                    s && !f.length && (d.teardown && !1 !== d.teardown.call(e, h, v.handle) || oe.removeEvent(e, p, v.handle), delete l[p])
        ...
        dispatch: function (e) {
            e = oe.event.fix(e);
            var t, n, i, r, o, s = [], a = J.call(arguments), l = (we.get(this, "events") || {})[e.type] || [],
        ...
        fix: function (e) {
            ...
            for (s || (this.fixHooks[r] = s = Ie.test(r) ? this.mouseHooks : He.test(r) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = i.length; t--;)n = i[t], e[n] = o[n];
    ...
    var Pe = /<script|<style|<link/i, Me = /checked\s*(?:[^=]|=\s*.checked.)/i, Re = /^true\/(.*)/,
        $e = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
    oe.extend({
        htmlPrefilter: function (e) {
            ...
            if (!(ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || oe.isXMLDoc(e)))for (s = u(a), o = u(e), i = 0, r = o.length; r > i; i++)w(o[i], s[i]);
            ...
            for (var t, n, i, r = oe.event.special, o = 0; void 0 !== (n = e[o]); o++)if (be(n)) {
                if (t = n[we.expando]) {
        ...
        domManip: C, detach: function (e) {
            ...
            for (var e,
                     t = 0; null != (e = this[t]); t++)1 === e.nodeType && (oe.cleanData(u(e, !1)), e.textContent = "");
            return this
        }, clone: function (e, t) {
            ...
            return xe(this, function (e) {
                ...
                if ("string" == typeof e && !Pe.test(e) && !qe[(je.exec(e) || ["", ""])[1].toLowerCase()]) {
        ...
        oe.fn[e] = function (e) {
            for (var n, i = [], r = oe(e), o = r.length - 1,
                     s = 0; o >= s; s++)n = s === o ? this : this.clone(!0), oe(r[s])[t](n), K.apply(i, n.get());
            return this.pushStack(i)
        }
    });
    var We, Be = {HTML: "block", BODY: "block"}, ze = /^margin/, _e = new RegExp("^(" + De + ")(?!px)[a-z%]+$", "i"),
        Xe = function (t) {
    ...
    !function () {
        function t() {
            ...
            n = "1%" !== t.top, o = "2px" === t.marginLeft, i = "4px" === t.width, a.style.marginRight = "50%", r = "4px" === t.marginRight, Ue.removeChild(s)
        }
    ...
    var Ye = /^(none|table(?!-c[ea]).+)/, Ge = {position: "absolute", visibility: "hidden", display: "block"},
        Je = {letterSpacing: "0", fontWeight: "400"}, Qe = ["Webkit", "O", "Moz", "ms"],
    ...
    oe.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                return t = oe.cssProps[a] || (oe.cssProps[a] = N(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], void 0 === n ? s && "get" in s && void 0 !== (r = s.get(e, !1, i)) ? r : l[t] : (o = typeof n, "string" === o && (r = Se.exec(n)) && r[1] && (n = c(e, t, r), o = "number"), void(null != n && n === n && ("number" === o && (n += r && r[3] || (oe.cssNumber[a] ? "" : "px")), ie.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l[t] = n))))
            }
        },
        css: function (e, t, n, i) {
            var r, o, s, a = oe.camelCase(t);
            return t = oe.cssProps[a] || (oe.cssProps[a] = N(a) || a), s = oe.cssHooks[t] || oe.cssHooks[a], s && "get" in s && (r = s.get(e, !0, n)), void 0 === r && (r = S(e, t, i)), "normal" === r && t in Je && (r = Je[t]), "" === n || n ? (o = parseFloat(r), !0 === n || isFinite(o) ? o || 0 : r) : r
        }
    }), oe.each(["height", "width"], function (e, t) {
        oe.cssHooks[t] = {
            get: function (e, n, i) {
                return n ? Ye.test(oe.css(e, "display")) && 0 === e.offsetWidth ? Ve(e, Ge, function () {
                    return L(e, t, i)
                }) : L(e, t, i) : void 0
            }, set: function (e, n, i) {
                var r, o = i && Xe(e), s = i && j(e, t, i, "border-box" === oe.css(e, "boxSizing", !1, o), o);
                return s && (r = Se.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = oe.css(e, t)), A(e, n, s)
            }
        }
    }), oe.cssHooks.marginLeft = E(ie.reliableMarginLeft, function (e, t) {
        return t ? (parseFloat(S(e, "marginLeft")) || e.getBoundingClientRect().left - Ve(e, {marginLeft: 0}, function () {
                return e.getBoundingClientRect().left
            })) + "px" : void 0
    }), oe.cssHooks.marginRight = E(ie.reliableMarginRight, function (e, t) {
        return t ? Ve(e, {display: "inline-block"}, S, [e, "marginRight"]) : void 0
    }), oe.each({margin: "", padding: "", border: "Width"}, function (e, t) {
        oe.cssHooks[e + t] = {
            expand: function (n) {
                for (var i = 0, r = {},
                         o = "string" == typeof n ? n.split(" ") : [n]; 4 > i; i++)r[e + Ee[i] + t] = o[i] || o[i - 2] || o[0];
                return r
            }
        }, ze.test(e) || (oe.cssHooks[e + t].set = A)
    }), oe.fn.extend({
        css: function (e, t) {
    ...
    oe.Animation = oe.extend(R, {
        tweeners: {
            ...
            for (var n, i = 0,
                     r = e.length; r > i; i++)n = e[i], R.tweeners[n] = R.tweeners[n] || [], R.tweeners[n].unshift(t)
        ...
        fadeTo: function (e, t, n, i) {
            ...
            return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                var t = !0, r = null != e && e + "queueHooks", o = oe.timers, s = we.get(this);
                if (r) s[r] && s[r].stop && i(s[r]); else for (r in s)s[r] && s[r].stop && nt.test(r) && i(s[r]);
                for (r = o.length; r--;)o[r].elem !== this || null != e && o[r].queue !== e || (o[r].anim.stop(n), t = !1, o.splice(r, 1));
                (t || !n) && oe.dequeue(this, e)
            })
        }, finish: function (e) {
            return !1 !== e && (e = e || "fx"), this.each(function () {
                var t, n = we.get(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = oe.timers,
                    s = i ? i.length : 0;
    ...
    oe.fn.extend({
        addClass: function (e) {
            ...
            if ("string" == typeof e && e)for (t = e.match(me) || []; n = this[l++];)if (r = $(n), i = 1 === n.nodeType && (" " + r + " ").replace(at, " ")) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function (n) {
                ...
                var t, i, r, o;
                if ("string" === n)for (i = 0, r = oe(this), o = e.match(me) || []; t = o[i++];)r.hasClass(t) ? r.removeClass(t) : r.addClass(t); else(void 0 === e || "boolean" === n) && (t = $(this), t && we.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : we.get(this, "__className__") || ""))
            })
        }, hasClass: function (e) {
            var t, n, i = 0;
            for (t = " " + e + " "; n = this[i++];)if (1 === n.nodeType && (" " + $(n) + " ").replace(at, " ").indexOf(t) > -1)return !0;
            return !1
        }
    });
    oe.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (e) {
                    for (var t, n, i = e.options, r = e.selectedIndex, o = "select-one" === e.type || 0 > r,
                             s = o ? null : [], a = o ? r + 1 : i.length,
                             l = 0 > r ? a : o ? r : 0; a > l; l++)if (n = i[l], (n.selected || l === r) && (ie.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !oe.nodeName(n.parentNode, "optgroup"))) {
                        if (t = oe(n).val(), o)return t;
                        s.push(t)
                    }
                    return s
                }, set: function (e, t) {
                    for (var n, i, r = e.options, o = oe.makeArray(t),
                             s = r.length; s--;)i = r[s], (i.selected = oe.inArray(oe.valHooks.option.get(i), o) > -1) && (n = !0);
    ...
    oe.extend(oe.event, {
        trigger: function (t, n, i, r) {
            var o, s, a, l, c, u, d, f = [i || G], p = ne.call(t, "type") ? t.type : t,
                h = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = a = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !lt.test(p + oe.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[oe.expando] ? t : new oe.Event(p, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : oe.makeArray(n, [t]), d = oe.event.special[p] || {}, r || !d.trigger || !1 !== d.trigger.apply(i, n))) {
                if (!r && !d.noBubble && !oe.isWindow(i)) {
                    for (l = d.delegateType || p, lt.test(l + p) || (s = s.parentNode); s; s = s.parentNode)f.push(s), a = s;
                    a === (i.ownerDocument || G) && f.push(a.defaultView || a.parentWindow || e)
                }
                for (o = 0; (s = f[o++]) && !t.isPropagationStopped();)t.type = o > 1 ? l : d.bindType || p, u = (we.get(s, "events") || {})[t.type] && we.get(s, "handle"), u && u.apply(s, n), (u = c && s[c]) && u.apply && be(s) && (t.result = u.apply(s, n), !1 === t.result && t.preventDefault());
                return t.type = p, r || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), n) || !be(i) || c && oe.isFunction(i[p]) && !oe.isWindow(i) && (a = i[c], a && (i[c] = null), oe.event.triggered = p, i[p](), oe.event.triggered = void 0, a && (i[c] = a)), t.result
            }
    ...
    var ct = e.location, ut = oe.now(), dt = /\?/;
    ...
    var ft = /([?&])_=[^&]*/, pt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
        ht = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, gt = /^(?:GET|HEAD)$/, vt = {}, mt = {},
        yt = "*/".concat("*"), xt = G.createElement("a");
    xt.href = ct.href, oe.extend({
        ...
        ajax: function (t, n) {
            ...
            if (f.data && f.processData && "string" != typeof f.data && (f.data = oe.param(f.data, f.traditional)), B(vt, f, n, C), 2 === b)return C;
    ...
    var bt = /\[\]$/, wt = /^(?:submit|button|image|reset|file)$/i, Ct = /^(?:input|select|textarea|keygen)/i;
    oe.param = function (e, t) {
        ...
        serialize: function () {
            ...
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !oe(this).is(":disabled") && Ct.test(this.nodeName) && !wt.test(e) && (this.checked || !Ae.test(e))
            }).map(function (e, t) {
                var n = oe(this).val();
    ...
    var Tt = {0: 200, 1223: 204}, kt = oe.ajaxSettings.xhr();
    ie.cors = !!kt && "withCredentials" in kt, ie.ajax = kt = !!kt, oe.ajaxTransport(function (t) {
        var n, i;
        return ie.cors || kt && !t.crossDomain ? {
            send: function (r, o) {
                ...
                n = function (e) {
                    return function () {
                        n && (n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Tt[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {binary: a.response} : {text: a.responseText}, a.getAllResponseHeaders()))
                    }
    ...
    oe.ajaxSetup({
        ...
        return a || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = oe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, a ? t[a] = t[a].replace(St, "$1" + r) : !1 !== t.jsonp && (t.url += (dt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
            return s || oe.error(r + " was not called"), s[0]
        }, t.dataTypes[0] = "json", o = e[r], e[r] = function () {
            s = arguments
        }, i.always(function () {
            void 0 === o ? oe(e).removeProp(r) : e[r] = o, t[r] && (t.jsonpCallback = n.jsonpCallback, Dt.push(r)), s && oe.isFunction(o) && o(s[0]), s = o = void 0
        }), "script") : void 0
    ...
    oe.fn.load = function (e, t, n) {
        ...
        setOffset: function (e, t, n) {
            ...
            "static" === u && (e.style.position = "relative"), a = d.offset(), o = oe.css(e, "top"), l = oe.css(e, "left"), c = ("absolute" === u || "fixed" === u) && (o + l).indexOf("auto") > -1, c ? (i = d.position(), s = i.top, r = i.left) : (s = parseFloat(o) || 0, r = parseFloat(l) || 0), oe.isFunction(t) && (t = t.call(e, n, oe.extend({}, a))), null != t.top && (f.top = t.top - a.top + s), null != t.left && (f.left = t.left - a.left + r), "using" in t ? t.using.call(e, f) : d.css(f)
        }
    }, oe.fn.extend({
        offset: function (e) {
            ...
            return o ? (t = o.documentElement, oe.contains(t, i) ? (r = i.getBoundingClientRect(), n = U(o), {
        ...
        oe.cssHooks[t] = E(ie.pixelPosition, function (e, n) {
            return n ? (n = S(e, t), _e.test(n) ? oe(e).position()[t] + "px" : n) : void 0
        })
    ...
    var Nt = e.jQuery, At = e.$;
    return oe.noConflict = function (t) {
        return e.$ === oe && (e.$ = At), t && e.jQuery === oe && (e.jQuery = Nt), oe
    }, t || (e.jQuery = e.$ = oe), oe
}), function (e, t) {
    "use strict";
    function n(e) {
        return {fast: 200, normal: 400, slow: 600}[e] || e
    }
    ...
    function o() {
        return JSON.parse(this.find(k + S).val() || "[]")
    }

    function s() {
        var t = e(this).find(k + q + " p"), n = e(this).children(k + S), i = [];
        t.each(function () {
            var t = e(this);
    ...
    function a(t) {
        for (var n, i = e(this).find(k + q + " p"), r = e(this).children(k + S), o = [], s = 0; s < i.length; s++) {
            var a = i.eq(s), l = t.indexOf(a.data("value"));
            t.indexOf(a.data("value")) >= 0 ? (n = a.find(":checkbox").prop("checked", !0), o.push(t[l])) : a.find(":checkbox").prop("checked", !1)
        }
        e(this).children("select").val(t), n && (n.trigger(T + "-chupdate", [!0]), r.val(JSON.stringify(o)))
    }

    function l(t) {
        var n = e(this), i = this.data(T), r = n.children("select"), o = n.children(k + S), s = n.children(k + D),
            a = r.find("option").filter(function () {
                return this.value == t
            });
        return s.removeClass(T + E).siblings(k + P).removeClass(T + P + E), a.length ? (n.find(k + q + " p").eq(a[0].index).addClass(T + H).siblings().removeClass(T + H), o.val(t).data("changed", !0), void r.val(t).change()) : (n.find(k + q + " p").removeClass(T + H), r.children().prop("selected", !1), i.invalidAsValue ? (i.highlightInvalid || (i.invalidAsValue ? i.highlightInvalid : null === i.highlightInvalid)) && s.addClass(T + E).siblings(k + P).addClass(T + P + E) : t = "", o.val(t), void s.val(t))
    }

    function c() {
        if (!this.data("listenersAdded")) {
            var n = this, i = n.data(T), r = null;
            this.on("keyup", k + D + ", " + k + N, function (t) {
                if (!([38, 40, 13, 27, 9, 37, 39, 17, 18, 16, 20, 33, 34, 35, 36].indexOf(t.which) >= 0)) {
                    var n = function (t) {
                        if ((t.ctrlKey || t.shiftKey || 45 != t.which) && (!t.ctrlKey || 65 != t.which)) {
                            var n = i.fullMatch, r = i.highlight;
                            r = n ? !1 !== r : !!r;
                            var o = e(this), s = this.value.trim();
                            i.filterIgnoreCase && (s = s.toLowerCase()), i.filterIgnoreAccents && String.prototype.latinize && (s = s.latinize());
                            var a = o.closest(k).children(k + q);
                            m.call(a, "down", !0);
                            var l = o.closest(k).find("select option");
                            if (e(k + " " + k + q).each(function () {
                                    a[0] != this && m.call(e(this), "up")
                                }), !s)return void a.children("p").show().each(function () {
                                e(k + "-marker", this).contents().unwrap()
                            });
                            var c = i.hideSeparatorsOnSearch ? "p" : "p:not(" + k + I + ", " + k + F + ")";
                            a.children(c).hide(), l.each(function () {
                                var t = e(this).text().trim();
                                if (i.filterIgnoreCase && (t = t.toLowerCase()), i.filterIgnoreAccents && String.prototype.latinize && (t = t.latinize()), n ? t.indexOf(s) >= 0 : 0 == t.indexOf(s)) {
                                    var o = i.filterIgnoreCase ? "i" : "",
                                        c = new RegExp("(" + s.replace(/([.?*+^$[\]\\(){}|-])/g, "\\$1") + ")", n ? o + "g" : o),
                                        u = a.children("p:eq(" + l.index(this) + "):not(" + k + I + ", " + k + F + ")").show();
                                    r && u.each(function () {
                                        e(k + "-marker", this).contents().unwrap();
                                        var t = e(k + O, this)[0];
                                        t.innerHTML = t.innerHTML.replace(c, '<span class="' + T + '-marker">$1</span>')
                                    })
                                }
                            })
                        }
                    }, o = this, s = i.filterDelay;
                    s ? (clearTimeout(r), r = setTimeout(function () {
                        n.call(o, t)
                    }, s)) : n.call(o, t)
                }
            }), this.on("keydown", k + D, function (t) {
                if ([38, 40, 13, 27, 9].indexOf(t.which) >= 0) {
                    9 != t.which && t.preventDefault();
                    var n, r, o = e(this).closest(k), s = o.children(k + q), a = e(k + H, s[0]), l = e("p:first", s[0]),
                        c = i.loopScrolling, u = ":not(" + k + I + "):not(" + k + F + ")",
                    ...
                    if (!s.is(":animated")) {
                        ...
                        var p = s.scrollTop();
                        if (40 == t.which) {
                            if (s.is(":hidden"))return void m.call(s, "down");
                            if (0 == a.length) n = l.is(":visible" + u) ? l.addClass(T + H) : l.nextAll(":visible" + u).first().addClass(T + H); else {
                                if (!c && !a.nextAll(":visible" + u).first().length)return;
                                n = a.removeClass(T + H).nextAll(":visible" + u).first().addClass(T + H), 0 == n.length && (n = l.is(":visible") ? l.addClass(T + H) : l.nextAll(":visible" + u).first().addClass(T + H)), 0 == n.length && (n = l), r = n.position().top - s.position().top;
                                var h = n.outerHeight();
                                r + 6 * h > s.height() ? r + 6 * h - s.height() > 1.5 * h ? s.scrollTop(p + r) : s.scrollTop(p + h) : 0 > r && s.scrollTop(p - -r)
                            }
                            d && (this.value = n.find(k + O).text(), o.children(k + D).data("fillonarrow", !0))
                        } else if (38 == t.which) {
                            if (s.is(":visible")) {
                                if (!c && !a.prevAll(":visible" + u).first().length)return;
                                n = a.removeClass(T + H).prevAll(":visible" + u).first().addClass(T + H), 0 == n.length && (n = e("p:visible" + u + ":last", s[0]).addClass(T + H)), r = n.position().top - s.position().top, h = n.outerHeight(), 3 * h > r ? s.scrollTop(p - -r - 3 * h) : r > s.height() - 3 * h && s.scrollTop(p + r - 3 * h), d && (this.value = n.find(k + O).text(), o.children(k + D).data("fillonarrow", !0))
                            }
                        } else if (13 == t.which) {
                            if (i.fillOnBlur)return void b(s).click();
                            s.children(k + H).click(), "default" == i.mode && m.call(s, "up")
                        } else if (27 == t.which) i.blurOnEscape ? e(this).blur() : e(this), s.is(":visible") && (m.call(s, "up"), t.stopPropagation()); else if (9 == t.which && i.fillOnTab && f) {
                            var g = s.children(k + H);
                            g.length && g.click()
                        }
                    }
                }
            }), this.on("change", "select", function (t, n) {
                var i = e(this).closest(k), r = e("option:selected", this).text();
                i.children(k + D).val(r).data("value", r);
                var o = i.children(k + S);
                return o.data("changed") ? void o.data("changed", !1) : n ? (s.call(i), void o.change()) : (o.change(), void m.call(i.children(k + q), "up"))
            }), this.on(T + "-chupdate", k + q + " p :checkbox", function (t, n) {
                n && (t.stopPropagation(), y.call(e(this).parent(), t, !0))
            }), this.on("click", k + q + " p", function (t) {
                if (clearTimeout(C), t.stopPropagation(), !e(this).is(k + I + ", " + k + F)) {
                    n.children(k + E).removeClass(T + E), n.children(k + P).removeClass(T + P + E);
                    var i = e(this), r = i.parent(), o = r.children(), s = o.index(this);
                    if ("checkboxes" == n.data(T).mode)return void y.call(this, t);
                    var a = r.closest(k).children("select");
                    a.children("option").eq(s).prop("selected", !0), a.siblings(k + S).val(a.val()), a.change(), m.call(i.parent(), "up"), i.addClass(T + H).siblings().removeClass(T + H)
                }
            }), this.on("blur", k + D, function (r) {
                var o = e(this), s = e(r.relatedTarget).closest(k);
                if (!(s.length > 0 && s[0] === o.closest(k)[0])) {
                    C = setTimeout(function () {
                        var i = e(this);
                        n.data(T), this === t.activeElement && i.data("silentfocus", !0), i.data("fillonarrow", !1), m.call(i.closest(k).children(k + q), "up")
                    }.bind(this), 200);
                    var a = o.val().trim(), l = o.siblings(k + S), c = l.val();
                    if (a) {
                        var u;
                        o.siblings("select").find("option").each(function () {
                            i.filterIgnoreCase ? a.toLowerCase() == e(this).text().trim().toLowerCase() && (u = this.value) : a == e(this).text().trim() && (u = this.value)
                        }), u ? l.val(u) : l.val(i.invalidAsValue ? a : "")
                    } else l.val("");
                    c !== l.val() && l.change().data("changed", !0)
                }
            }), this.on("focus", k + D, function () {
                if (e(this).data("silentfocus"))return void e(this).data("silentfocus", !1);
                if (this.value.trim()) {
                    if (n.data(T).expandOnFocusWithValue || e(this).data("expandfocus"))if (n[T]("val")) {
                        var t = n.children(k + q);
                        t.children().show(), m.call(t, "down")
                    } else e(this).keyup()
                } else(n.data(T).expandOnFocus || e(this).data("expandfocus")) && e(this).keyup();
                e(this).data("expandfocus", !1)
            }), this.on("click", k + D + "-div", function () {
                n.data(T).disabled || m.call(e(this).siblings(k + q), "down")
            }), this.on("click", k + D, function (t) {
                var n = e(this).closest(k)[0];
                e(k).each(function () {
                    this != n && e(this)[T]("close")
                }), t.stopPropagation()
            }), this.on("click", k + M, function (t) {
                clearTimeout(C);
                var n = e(this), i = n.closest(k), r = i.children(k + q);
                r.is(":visible") ? (m.call(r, "up"), i.children(k + D).data("silentfocus", !0).focus()) : i.children(k + D).data("expandfocus", !0).focus()
            }), this.on("click", k + j, function (t) {
                clearTimeout(C), t.stopPropagation();
                var r = e(this), o = r.parent();
                n.children(k + q).children("p").eq(r.data("index")).find(":checkbox").prop("checked", !1), o.fadeOut(i.animation.duration), r.closest(k).children("select").trigger("change", [!0])
            }), i.autoLoad != e.noop && e(k + q, this).scroll(function () {
                var t = e(this), r = n.children("select"), o = t.scrollTop();
            ...
            }).data("scrollTop", 0), e(t).bind("click." + T, {thisIs: this}, function (t) {
                m.call(e(t.data.thisIs).children(k + q), "up")
    ...
    function f(t) {
        for (var n = 0; n < t.length; n++)t[n].value || e(t[n]).hasClass(T + I) || "optgroup" == t[n].tagName.toLowerCase() || e(t[n]).remove()
    }

    function p(e, t) {
        var n = e.text.trim().toLowerCase(), i = t.text.trim().toLowerCase();
        return n > i ? 1 : n == i ? 0 : -1
    }

    function h(e) {
        for (var t = 0; t < e.length; t++)for (var n = t + 1; n < e.length; n++)e[t] && e[n] && e[t].value == e[n].value && e.splice(t, 1)
    }

    function g(t) {
        for (var n = 0; n < t.length; n++)for (var i = n + 1; i < t.length; i++)t[n] && t[i] && t[n].value == t[i].value && "optgroup" != t[n].tagName.toLowerCase() && e(t[n]).remove()
    }

    function v() {
        var t, n = this.children(k + D), i = this.children("select"), r = this.data(T), o = n.val().trim();
        ...
        }), !t && o ? (r.forbidInvalid ? n.closest(k).find(k + D).val("").data("value", "") : (r.highlightInvalid || (r.invalidAsValue ? r.highlightInvalid : null === r.highlightInvalid)) && n.addClass(T + E).siblings(k + P).addClass(T + P + E), r.invalidAsValue || n.siblings("select, " + k + S).val("")) : n.removeClass(T + E).siblings(k + P).removeClass(T + P + E)
    }

    function m(t, n) {
        if (!this.is(":animated") && this.length && ("up" != t || !this.is(":hidden") || 1 != this.length)) {
            var i = this.parent().data(T).animation;
            e.easing[i.easing] || (console.warn("no such easing: " + i.easing), i.easing = "swing");
            var r = this.parent(), o = r.data(T);
            "up" == t ? (o.beforeClose.call(r), i.complete = function () {
                "checkboxes" != o.mode && v.call(r), o.afterClose.call(r)
            }, this.slideUp(i).data("p-clicked-index", -1), r.children(k + M).removeClass(T + M + "-up")) : (o.beforeOpen.call(r), i.complete = function () {
                o.afterOpen.call(r)
            }, this.slideDown(i), r.children(k + M).addClass(T + M + "-up"), r.find(k + H).removeClass(T + H), e(k + "-marker", r).contents().unwrap(), r.children(k + q).children("p").show());
            r.children(k + D).each(function () {
                var i = e(this);
                if (i.data("fillonarrow") && !n && i.data("fillonarrow", !1).val(i.data("value")), "down" == t) {
                    var s = this.value.trim();
                    o.filterIgnoreCase && (s = s.toLowerCase());
                    var a = r.find("select option");
                    a.each(function () {
                        var t = e(this).text().trim();
                        return o.filterIgnoreCase && (t = t.toLowerCase()), t == s ? (r.children(k + q).children("p:eq(" + a.index(this) + "):not(" + k + I + ", " + k + F + ")").first().addClass(T + H), !1) : void 0
                    })
                }
            })
        }
    ...
    function y(t, i) {
        var r = e(this), o = r.closest(k), s = r.parent(), a = s.children("p"), l = a.index(this),
            c = n(s.parent().data(T).animation.duration);
        if (!i) {
            var u = r.find(":checkbox");
            e(t.target).is(":checkbox") || u.prop("checked", !u.prop("checked"));
            var d = u.prop("checked");
            if (t.shiftKey && s.data("p-clicked-index") >= 0)for (var f = s.data("p-clicked-index"), p = l > f ? f : l,
                                                                      h = l > f ? l : f,
                                                                      g = p; h >= g; g++)e(a[g]).find(":checkbox").prop("checked", d)
        }
        var v = o.find(k + L).prepend("<span />");
        o.find(k + L).fadeOut(c / 5, function () {
            v.empty().show(), a.each(function (t) {
                var n = e(this);
                n.find(":checkbox").prop("checked") && v.append(e("<div />").addClass(T + A).append(e("<div />").addClass(T + A + "-text").text(n.find(k + O).text())).append(e("<div />").addClass(T + j).text("×").data("index", t)).fadeIn(1.5 * c).attr("title", n.attr("title")))
            }), v.append('<div style="clear: both" />')
        }), s.data("p-clicked-index", l), r.closest(k).children("select").trigger("change", [!0])
    }

    function x(t, n) {
        for (var i = this.data(T), r = this.find("select"), o = this.find(k + q), s = 0; s < t.length; s++) {
            if (t[s].hasOwnProperty("separator")) {
                if (t[s].hasOwnProperty("header")) a = e('<p class="' + T + F + '" />').text(t[s].header); else var a = e('<p class="' + T + I + '" />');
                var l = e("<option />")
            } else l = e("<option />").val(t[s].value).text(t[s].text).prop("selected", !!t[s].selected), a = i.pFillFunc.call(this, t[s], i), "checkboxes" == i.mode && a.prepend('<input type="checkbox" />');
            a.data("value", t[s].value), n ? (r.prepend(l), o.prepend(a)) : (r.append(l), o.append(a))
        }
    }

    function b(e) {
        var t = e.children(k + H + ":visible");
    ...
    var C, T = "scombobox", k = "." + T, D = "-display", S = "-value", E = "-invalid", N = D + "-div", A = N + "-item",
        j = A + "-remove", L = N + "-holder", q = "-list", O = "-mainspan", H = "-hovered", I = "-separator",
        F = "-header", P = "-dropdown-background", M = "-dropdown-arrow", R = "-disabled", $ = parseInt, W = {
            init: function () {
                var t = this.find(k + q), n = this.find("select"), i = this.find(k + P), r = this.find(k + M),
                    o = this.data(T);
                if (this.addClass(T), 0 == n.length && this.append(e("<select />")), this.attr("id") && n.removeAttr("id"), n.attr("multiple") && (this.data(T).mode = "checkboxes"), 0 == i.length && this.append('<div class="' + T + P + '" />'), 0 == r.length && this.append('<div class="' + T + M + '" />'), W.displayDropdown.call(this, o.showDropDown), "checkboxes" != o.mode && 0 == this.find(k + D).length) {
                    var s = e('<input class="' + T + D + '" type="text" />');
                    s.attr("title", n.attr("title")), s.attr("placeholder", o.placeholder), this.append(s), this.height(+s.css("font-size") + +s.css("padding-top") + +s.css("padding-bottom"))
                }
                if (null != o.tabindex && this.find(k + D).attr("tabindex", o.tabindex), 0 == this.find(k + S).length && this.append('<input class="' + T + S + '" type="hidden" />'), (this.find(k + D).is(":disabled") || o.disabled) && this.find(k + P + ", " + k + M).hide(), o.disabled && (this.find(k + D).prop("disabled", !0), this.addClass(T + R)), (n.attr("required") || o.required) && (this.find(k + D).prop("required", "required"), this.addClass(T + "-required")), 0 == t.length && this.append(t = e('<div class="' + T + q + '"></div>')), "checkboxes" == o.mode) {
                    this.addClass(T + "-checkboxes"), this.find(k + D).remove();
                    var a = this.find(k + D + "-div");
                    0 == a.length && (a = this.append('<div class="' + T + N + '"><div class="' + T + L + '" /></div>')), a.attr("title", n.attr("title")), t.insertAfter(this.find(k + D + "-div"));
                    var l = this.find(k + L),
                        u = e('<div class="' + T + A + '" id="' + T + '-test-item"><div class="' + T + A + '-text">x</div></div>');
                    ...
                    this.find(k + D + "-div").css("min-height", d + "px"), u.remove()
                } else this.find(k + "-display-div").remove(), t.insertAfter(this.find(k + D));
                return t.css({
                    "max-width": o.listMaxWidth,
                    "max-height": o.maxHeight
                }), 1 == o.wrap && t.css("white-space", "normal"), o.autoLoad != e.noop && (o.loopScrolling = !1), c.call(this), this.data(T + "-init", !0), W.fill.call(this, o.data)
            }, fill: function (t, n) {
                var i = this.find("select").children("option, optgroup"), r = this.find("." + T + q),
                    o = this.find("select");
                t = u(t);
                var s = this.data(T), a = s.mode;
                if (t ? (s.removeDuplicates && h(t), d(t), s.sort && (t.sort(p), s.sortAsc || t.reverse()), n || (o.empty(), r.empty(), this.children(k + S + ", " + k + D).val("")), x.call(this, t, 2 == n)) : (s.removeDuplicates && (g(i), f(i), i = this.find("select").children("option, optgroup")), 0 == i.length || i.each(function () {
                        var t = e(this), n = e("<p />");
                        if (n.attr("title", t.attr("title")), t.hasClass(T + I)) t.hasClass(T + F) ? r.append(n.addClass(T + F).text(t.text())) : n.addClass(T + I); else {
                            if ("optgroup" == this.tagName.toLowerCase()) {
                                var i = t.attr("label"), o = e("option", this);
                                return t.before("<option />"), t.after(o), t.remove(), r.append(i ? n.addClass(T + F).text(i) : n.addClass(T + I)), void o.each(function () {
                                    r.append(e("<p />").attr("title", this.title).append(e('<span class="' + T + O + '" />').text(e(this).text())).data("value", this.value))
                                })
                            }
                            n.append(e('<span class="' + T + O + '" />').text(t.text())).data("value", this.value), "checkboxes" == a && n.prepend('<input type="checkbox" />')
                        }
                        r.append(n)
                    })), this.data(T + "-init") && (s.callback.func.apply(this, s.callback.args), this.data(T + "-init", !1)), i = this.find("select").children("option"), !s.empty)if ("checkboxes" != a) this[T]("val", i.filter("option:selected:last").val()); else {
                ...
                return this.children("select").empty(), this.children(k + q).empty().width(""), this.children(k + D).removeClass(T + E), this.children(k + P).removeClass(T + P + E), this
            }, data: function (e) {
                return 0 == arguments.length ? this.data(T).data : (this.data(T).data = e, this)
            }, disabled: function (e) {
                var t = this.data(T).mode;
                return 0 == arguments.length ? "checkboxes" == t ? this.hasClass(T + R) : this.children(k + D).prop("disabled") : (e = !!e, this.children(k + D).prop("disabled", e), e ? (this.addClass(T + R), this.children(k + P + ", " + k + M).hide()) : (this.removeClass(T + R), this.children(k + P + ", " + k + M).show()), this)
            }, tabindex: function (e) {
                var t = this.find(k + D);
                return 0 == arguments.length ? t.attr("tabindex") : (t.attr("tabindex", e), this)
            }, options: function (t) {
                return 0 == arguments.length ? this.data(T) : (e.extend(!0, this.data(T), w(t)), this)
            }, val: function (e) {
                var t = this.data(T), n = t.mode;
                if (0 == arguments.length) {
                    if ("default" == n)var i = this.find(k + S).val();
                    return "default" == n ? this.find(k + D).is(":disabled") ? "" : i : "checkboxes" == n ? o.call(this) : null
                }
                return "default" == n ? l.call(this, e) : "checkboxes" == n && a.call(this, e), this
            }, open: function () {
                return m.call(this.children(k + q), "down"), this
            }, close: function () {
                return m.call(this.children(k + q), "up"), this
            }, change: function (e, t) {
                return i.call(this, "change", this.children(k + S), e, t)
            }, focus: function (e, t) {
                return i.call(this, "focus", this.children(k + D), e, t)
            }, blur: function (e, t) {
                return i.call(this, "blur", this.children(k + D), e, t)
            }, keyup: function (e, t) {
                return i.call(this, "keyup", this.children(k + D), e, t)
            }, keydown: function (e, t) {
                return i.call(this, "keydown", this.children(k + D), e, t)
            }, keypress: function (e, t) {
                return i.call(this, "keypress", this.children(k + D), e, t)
            }, click: function (e, t) {
                return i.call(this, "click", this.children(k + D), e, t)
            }, mousedown: function (e, t) {
                return i.call(this, "mousedown", this.children(k + D), e, t)
            }, clickDropdown: function (e, t) {
                return i.call(this, "click", this.children(k + M), e, t)
            }, toSelect: function () {
                var e = this.children("select").insertAfter(this);
                return this.data(T).reassignId && e.attr("id", this.attr("id")), this.remove(), e
            }, displayDropdown: function (e) {
                return arguments.length ? e ? this.children(k + M + ", " + k + P).show() : this.children(k + M + ", " + k + P).hide() : this.data(T).showDropdown ? this.children(k + M + ", " + k + P).show() : this.children(k + M + ", " + k + P).hide(), this
            }, placeholder: function (e) {
                var t = this.children(k + D);
                return arguments.length ? (t.attr("placeholder", e), this) : t.attr("placeholder")
            }
        };
    e.fn[T] = function (t) {
        if ("string" == typeof t) {
            this.length || e.error("Calling " + T + "." + t + "() method on empty collection"), null == this.data(T + "-init") && e.error("Calling " + T + "." + t + "() method prior to initialization");
            var n = W[t];
            n || e.error("No such method: " + t + " in jQuery." + T + "()")
        } else {
            if (!(["object", "undefined"].indexOf(typeof t) >= 0))return e.error("Incorrect usage"), this;
            var i = e.extend(!0, {}, e.fn[T].defaults, w(t))
        }
        return n ? n.apply(this, Array.prototype.slice.call(arguments, 1)) : this.each(function () {
            var t = e(this);
            t.parent().hasClass(T) || (t.is("select") && (t.wrap("<div />"), i.reassignId && t.parent().attr("id", t.attr("id")), t = t.parent()), t.data(T, e.extend(!0, {}, i)), W.init.apply(t))
        })
    }, e.fn[T].defaults = {
        data: null,
        empty: !1,
        ...
        loopScrolling: !0,
        placeholder: ""
    }, e.fn[T].extendDefaults = function (t) {
        e.extend(!0, e.fn[T].defaults, t)
    }
    ...
    // CHANGE BACKGROUND COLOR
        ...
        $("#blueBg").css("opacity", "" + (1 - e.pageY / 1e3)), console.log(e)
    })
